...
import { IoEye as PasswordHide } from "react-icons/io5";
import { IoEyeOff as PasswordShow } from "react-icons/io5";
          ...
          <div className="flex flex-col gap-1 w-full">
            ...
            <div className="relative w-full">
              <input
                ...
                id="password"
                className="border w-full border-gray-400 px-2 py-1 rounded-md outline-none"
                name="password"
                value={data.password}
                onChange={handleChange}
                disabled={loading}
